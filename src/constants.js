...
export const HOW_ITEMS = [
  {
    title: "Capture",
    description:
      "Collect a crop image from the field using a camera or device feed.",
  },
  {
    title: "Assess",
    description:
      "Analyze the plant structure, leaf health, and visible stress patterns.",
  },
  {
    title: "Diagnose",
    description:
      "Compare image signals against trained crop-health indicators.",
  },
  {
    title: "Act",
    description:
      "Receive a practical insight on plant condition and intervention need.",
  },
];
...
export const WHY_ITEMS = [
  ...
  },
  {
    ...
    description:
      "Support remote inspection with a simple mobile-friendly dashboard.",
    icon: "signal",
  },
  {
    title: "Farmer-ready",
